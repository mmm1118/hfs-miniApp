...
Page({
  ...
  onLoad: function (options){
    ...
    that.selectFansByPage(sessionId,userid)
  },
  selectFansByPage(sessionId, userid){
    const that=this;
    const data={ 
    ...
    myapi.selectFansByPage(sessionId, data).then(res=>{
      console.log(res)
  ...
  follow(e){ 
    ...
    myapi.selectFollowEachOther(sessionId,openid).then(res=>{
        console.log(res)
    }).catch(err=>{ 
        console.log(err)
    })
